...
from train_c3d_ufc101 import placeholder_inputs, _variable_on_cpu, _variable_with_weight_decay
...
def run_test():
    ...
    for step in range(all_steps):
        ...
        for i in range(0, valid_len):
            ...
            write_file.write('{}, {}, {}, {}\n'.format(true_label[0], predict_score[i][true_label], top1_predicted_label, predict_score[i][top1_predicted_label]))
    write_file.close()
    print("done")
